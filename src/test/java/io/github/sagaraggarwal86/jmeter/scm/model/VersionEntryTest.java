...
class VersionEntryTest {
    ...
    void constructorSetsAllFields() {
        ...
        VersionEntry entry = new VersionEntry(1, "v001.jmxv", now, TriggerType.CHECKPOINT, "note", "abc123");
    ...
    void equalsByVersionAndFile() {
        ...
        VersionEntry a = new VersionEntry(1, "v001.jmxv", t1, TriggerType.CHECKPOINT, null, "abc");
    ...
    void notEqualWhenVersionDiffers() {
        VersionEntry a = new VersionEntry(1, "v001.jmxv", LocalDateTime.now(), TriggerType.CHECKPOINT, null, "abc");
        VersionEntry b = new VersionEntry(2, "v001.jmxv", LocalDateTime.now(), TriggerType.CHECKPOINT, null, "abc");
